            ...
            <div class="am-tabs-bd">
                    ...
                    <form class="am-form am-form-horizontal" id="information-form" action="${ctx}/${userid}/update" method="post" data-am-validator>
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-10 am-u-sm-offset-2">
                                <button type="submit" class="am-btn am-round am-btn-primary"><span class="am-icon-send"></span> 提交</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="am-tab-panel am-fade" id="tab2">
                    <form class="am-form am-form-horizontal" action="${ctx}/${userid}/upload" enctype="multipart/form-data" method="post" onsubmit="return checkFileType();" style="text-align: center;">
                        <div style="text-align: center; margin-bottom: 10px;">
                            <img class="am-circle" src="${ctx}/${user.profilehead}" width="140" height="140" alt="User Avatar"/>
                        </div>
                        ...
                        <button type="submit" class="am-btn am-round am-btn-primary"><span class="am-icon-upload"></span> 上传头像</button>
                        <script>
                            $(function() {
                ...
                <div class="am-tab-panel am-fade" id="tab3">
                    <form class="am-form am-form-horizontal" data-am-validator action="${ctx}/${userid}/pass" method="post">
                        ...
                        <div class="am-form-group">
                            <div class="am-u-sm-10 am-u-sm-offset-2">
                                <button type="submit" class="am-btn am-round am-btn-primary"><span class="am-icon-send"></span> 提交修改</button>
                            </div>
                        </div>
                    </form>
                </div>
